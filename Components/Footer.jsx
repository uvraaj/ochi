...
function Footer() {
  return (
    <div className='w-full h-screen bg-zinc-100 p-20 flex gap-5 font-["Founders Grotesk X-Condensed"]'>
        <div className='w-1/2  h-full flex flex-col justify-between'>
            <div className='heading'>
            <h1 className='text-[8vw]
            font-bold uppercase leading-none -mb-5 tracking-tighter'>eye-</h1>
            <h1 className='text-[8vw]
            font-bold uppercase leading-none -mb-5 tracking-tighter'>opening</h1>
            </div>
        ...
        <h1 className='text-[6vw]
            font-semibold uppercase leading-none -mb-8 tracking-tighter'>presentations
            </h1>
            <div className='detailsContainer mt-6'>
            <div className='Details'>
             {["Facebook","Instagram","Twitter",].map((items, index) => (<a key={index} className={'font-NeueMontreal block text-xl font-light'}>{items}</a>))} 
            </div>
            </div>
